  ...
  <div class="room-change-container">
    ...
    <div class="images-section">
      <div class="hostel-image">
        <img src="../assets/room 1.jpg" alt="Modern hostel accommodation">
         </div>
      <div class="hostel-image">
        <img src="../assets/room 2.jpg" alt="Hostel room with bunk beds">
        </div>
      <div class="hostel-image">
        <img src="../assets/room 3.jpg" alt="Clean hostel room">
      </div>
    </div>
  </div>
</template>
